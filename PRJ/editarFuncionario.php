...
if(!isset($_SESSION))
  session_start();
$consulta = "SELECT * FROM funcionario WHERE id = '$_SESSION[idEditarFuncionario]'";
...
//Update no BD
  ...
  $sql_code = "UPDATE funcionario set 
    ...
    email = '$_SESSION[email]'
     WHERE id = '$_SESSION[idEditarFuncionario]'";
...
<div class="container">
  ...
  <div class="col-md-9 personal-info">
     ...
     <form class="form-horizontal" action="editarFuncionario.php?p=cadastrar" method="POST">
