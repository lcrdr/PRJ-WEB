...
$consulta = "SELECT * FROM recebimento";
...
<article>
  <div class="container">
    ...
    <label data-toggle="collapse" data-target="#div-relatorio">Relatório de histórico de transações</label><br>
      <button onclick="geraRelatorio()">Gerar</button><br>
             ...
             <tbody>
               <?php while ($dado = $con->fetch_array()) { ?>
                <tr class="table-hover">
                  <td><?php echo $dado["nomeProcedimento"]; ?></td>
                  <td><?php echo $dado["valorPago"]; ?></td>
