...
if(!isset($_SESSION))
  session_start();
$consulta = "SELECT * FROM procedimento WHERE id = '$_SESSION[idEditarProcedimento]'";
...
//Update no BD
  ...
  $sql_code = "UPDATE procedimento set 
    nome = '$_SESSION[nomeProc]',
    valor ='$_SESSION[valor]', 
    duracao = '$_SESSION[duracao]', 
    observacao = '$_SESSION[observacao]'
     WHERE id = '$_SESSION[idEditarProcedimento]'";
...
<div class="container">
  ...
  <div class="col-sm-12 personal-info article-inicio row">
    ...
    <form class="formCadastroN" action="editarProcedimento.php?p=cadastrar" method="POST">
...
<!-- --------------------------------------- -->
      ...
      <div class="row">
        <div class="column">
          ...
          <input class="form-control" type="text" name="nomeProc" value="<?php echo $dado["nome"] ?>">
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                ...
                <input class="form-control" type="text" name="valor" required="true" value="<?php echo $dado["valor"] ?>">
            ...
            <div class="form-group">
             ...
             <div class="col-lg-8">
               <input type="text" id="dinheiro" class="dinheiro form-control" style="display:inline-block" name="duracao"   value="<?php echo $dado["valor"] ?>">
...
<textarea class="form-control" rows="5" id="comment" name="observacao"><?php echo $dado["observacao"] ?>
          </textarea>           
         </textarea>
       </div>
     </div>
