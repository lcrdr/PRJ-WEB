...
$consulta = "SELECT * FROM funcionario WHERE id = '$_SESSION[usernameFunc]'";
  ...
  <div class="page-content inset">
    <div class="row">
      <div class="col-md-11 text-center">
          ...
          <div class="container p-5">
            ...
            <div class="form-row">
              <div class="form-group col-md-5">
                ...
                placeholder="Nome do Funcionário"  value="<?php echo $dado["nome"] ?>"  required>
              </div>
                            <div class="form-group col-md-5">
                <label for="nome">Sobrenome:</label> <input type="text"
                class="form-control" name="nome" id="nome"
                placeholder="Sobrenome do Funcionário" th:field="*{nome}" required>
              </div>
            </div>
            <div class="form-row">
        ...
        <hr>
        <button
        type="button" class="btn btn-primary">Salvar</button></a>
